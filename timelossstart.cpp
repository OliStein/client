...
void timeLossStart(TCPClient * c, TimeLossSettings * tlc)
{
    std::cout << "timeLoss started" << std::endl;
...
int main(int argc, char* argv[])
{
    try
    {
        ...
        {
            timeLossStart(&c, tlc); // Setup the Time Loss mode, get the histogram data
